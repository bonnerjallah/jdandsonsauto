...
function style2(node, property2) {
  ...
  var transforms = "";
  if (typeof property2 === "string") {
    return node.style.getPropertyValue(hyphenateStyleName2(property2)) || getComputedStyle2(node).getPropertyValue(hyphenateStyleName2(property2));
  }
  Object.keys(property2).forEach(function(key) {
    var value = property2[key];
    if (!value && value !== 0) {
...
function TimeGridEvent(props) {
  ...
  var start = accessors.start(event);
  var userProps = getters.eventProp(event, start, end, selected);
  var height2 = style3.height, top = style3.top, width = style3.width, xOffset = style3.xOffset;
...
var DayColumn = function(_React$Component) {
  ...
  _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max2), className = _dayProp.className, style3 = _dayProp.style;
